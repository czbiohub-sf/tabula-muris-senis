...
#SBATCH --array=1-71                  # Partition to run in
...
analyte=$(head -n ${i_analyte} "${ROOT_FOLDER}/DGE_result/droplet.tc_list" | tail -1 )
analyte=${analyte// /_} 
echo $analyte

OUTPUT_FOLDER="${ROOT_FOLDER}/DGE_result/DGE_droplet_tc.n_gene.male_only"
n_gene="T"
DATA_NAME="droplet"
KEEP_SEX="M"
