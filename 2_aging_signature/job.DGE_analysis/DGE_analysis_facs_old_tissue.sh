...
#SBATCH --array=15                     # Partition to run in
...
tissue=$(head -n ${i_tissue} "${ROOT_FOLDER}/DGE_result/facs_old.tissue_list" | tail -1 )
echo $tissue

OUTPUT_FOLDER="${ROOT_FOLDER}/DGE_result/DGE_facs_old_tissue"
n_gene="F"
DATA_NAME="facs_old"
