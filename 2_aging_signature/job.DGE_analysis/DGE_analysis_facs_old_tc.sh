...
#SBATCH --array=12,84-86                     # Partition to run in
...
analyte=$(head -n ${i_analyte} "${ROOT_FOLDER}/DGE_result/facs_old.tc_list" | tail -1 )
analyte=${analyte// /_} 
echo $analyte

OUTPUT_FOLDER="${ROOT_FOLDER}/DGE_result/DGE_facs_old_tc"
n_gene="F"
DATA_NAME="facs_old"
